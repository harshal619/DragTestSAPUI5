...
sap.m.SplitAppRenderer.render = function(rm, oControl){
	...
	sap.m.BackgroundHelper.renderBackgroundImageTag(rm, oControl, "sapMSplitAppBG",  oControl.getBackgroundImage(), oControl.getBackgroundRepeat(), oControl.getBackgroundOpacity());
