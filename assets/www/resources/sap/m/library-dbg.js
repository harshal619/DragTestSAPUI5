...
/**
 * Initialization Code and shared classes of library sap.m (1.14.1)
 */
...
sap.m.ImageHelper = (function($, window) {
	...
	return {
		 ...
		 * @function
		 */
		getImageControl: function(sImgId, oImageControl, oParent, mProperties, aCssClasses) {
			...
			if (!!oImage && (oImage instanceof sap.m.Image || oImage instanceof sap.ui.core.Icon)) {
				...
				if(!!aCssClasses) {
					for (var k = 0, len = aCssClasses.length; k !== len; k++) {
						oImage.addStyleClass(aCssClasses[k]);
					}
				}
			}
